...
description: Translate a course README.md into a matching README.eng.md mirror while preserving Markdown structure, links, tables, and inline HTML.
---
...
5. Write the result to `README.eng.md` in the repository root.
6. For future updates, run `scripts/translate_readme.py` from the repository root.
...
- Do not include the English-version page link on the first line.
